...
As detailed above outcome variables analyzed in this report were found in the Cumulative CES Policy Preference data and are the 3 environmental policies noted above.

These preferences were obtained through a survey where respondents could select support or oppose for the policies presented. With this in mind, each of the outcome variable 
```{r}
outcome_ces |>
  ggplot()+
  geom_bar(
  ...
  labs(title = "Distribution of Carbon Regulation Policy Support",
       x = "Support for Increased Carbon Regulation",
       y = "Proportion",
...
outcome_ces |>
  ...
  labs(title = "Distribution of Increased Renewable Energy Support",
       x = "Support for Increased Renewable Energy",
       y = "Proportion",
       caption = "Source: Cumulative CES Policy Preferences")
```
```{r}
outcome_ces |>
  ...
  geom_bar(
    aes(
      x = enviro_airwateracts,
      y = ..count../sum(..count..)
    ), width = .25
  ) +
  labs(title = "Distribution of Support for increased enforcement of CWA/CAA",
       x = "Support for Increased Enforcement",
       y = "Proportion",
       caption = "Source: Cumulative CES Policy Preferences")
```
